          ...
          '<table cellspacing="0" cellpadding="0">',
            '<thead>',
              ...
              '<tr class="datepickerDoW">',
                '<th class="week-sun"><span><%=day1%></span></th>',
                '<th><span><%=day2%></span></th>',
                '<th><span><%=day3%></span></th>',
                '<th><span><%=day4%></span></th>',
                '<th><span><%=day5%></span></th>',
                '<th><span><%=day6%></span></th>',
                '<th class="week-sat"><span><%=day7%></span></th>',
              '</tr>',
            '</thead>',
          '</table></td>'
        ],
        space : '<td class="datepickerSpace"><div class="top"></div><div></div></td>',
        days: [
      ...
      fill = function(el) {
        ...
        for(var i = 0; i < options.calendars; i++) {
          ...
          if(tblCal.hasClass('datepickerViewDays')) {
            dow = date.getFullYear()+" / "+date.getMonthName(true);
            ...
            if (el.hasClass('datepickerMonth')) {
              ...
              if(options.mode == 'range') {
                ...
                if(tblEl.eq(0).hasClass('datepickerViewDays')) {
                  ...
                  el.find('span').text(tmp.getFullYear()+" / "+tmp.getMonthName(true));
                }
              }
